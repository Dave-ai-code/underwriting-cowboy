...
export default function ToolkitPage() {
  ...
  return (
    <Page>
      ...
      {/* TABS */}
      <div style={{
        display: 'flex', borderTop: `1px solid ${UC.ink}`,
        ...
        {TABS.map(({ id, label }) => (
          ...
          >
            <div style={{ fontFamily: UC.sans, fontSize: 15, fontWeight: activeTab === id ? 600 : 400 }}>
              {label}
            </div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: 20 }}>
            {promptLibrary.map(p => (
              ...
              >
                ...
                <div style={{ fontFamily: UC.serif, fontSize: 18, lineHeight: 1.3 }}>{p.title}</div>
                <div style={{
